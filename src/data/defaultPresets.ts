...
export const defaultPresets: BannerPreset[] = [
  {
    ...
    typography: { titleFont: "Inter", weight: 700, scale: 1, letterSpacing: 0, uppercase: false, shadow: true },
    glyph: "✦",
    seed: "gradient-field",
  },
  {
    ...
    pattern: "grid",
    texture: "subtle-noise",
    typography: { titleFont: "Inter", weight: 700, scale: 1, letterSpacing: 0.01, uppercase: false, shadow: false },
    glyph: "▦",
  ...
  },
  {
    ...
    pattern: "topographic",
    texture: "grain",
    typography: { titleFont: "Inter", weight: 800, scale: 0.95, letterSpacing: 0, uppercase: false, shadow: true },
    glyph: "◬",
    seed: "topographic",
  },
  {
    ...
    texture: "none",
    typography: { titleFont: "JetBrains Mono", weight: 700, scale: 0.9, letterSpacing: 0, uppercase: false, shadow: false },
    glyph: "›_",
    seed: "terminal",
  },
  {
    ...
    texture: "vignette",
    typography: { titleFont: "Inter", weight: 800, scale: 1.05, letterSpacing: 0.04, uppercase: true, shadow: true },
    glyph: "✺",
    seed: "radial-burst",
  },
  {
